...
export const PRIORITY_CONFIG = {
  High:   { label: 'High',   color: 'border-red-200 bg-red-50 text-red-700 dark:border-red-900/50 dark:bg-red-900/20 dark:text-red-400', chartColor: '#ef4444' },
  Medium: { label: 'Medium', color: 'border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-900/50 dark:bg-amber-900/20 dark:text-amber-400', chartColor: '#f59e0b' },
  Low:    { label: 'Low',    color: 'border-green-200 bg-green-50 text-green-700 dark:border-green-900/50 dark:bg-green-900/20 dark:text-green-400', chartColor: '#10b981' },
};
